...
typedef struct tyObject_PathIter__podQ0J5k3gvdWjKZmv8yZg tyObject_PathIter__podQ0J5k3gvdWjKZmv8yZg;
...
struct tyObject_PathIter__podQ0J5k3gvdWjKZmv8yZg {
	NI i;
	NI prev;
	NIM_BOOL notFirst;
};
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, hasNext__pureZpathnorm_u6)(tyObject_PathIter__podQ0J5k3gvdWjKZmv8yZg it_p0, NimStringV2 x_p1);
N_LIB_PRIVATE N_NIMCALL(tyTuple__1v9bKyksXWMsm0vNwmZ4EuQ, next__pureZpathnorm_u10)(tyObject_PathIter__podQ0J5k3gvdWjKZmv8yZg* it_p0, NimStringV2 x_p1);
...
N_LIB_PRIVATE N_NIMCALL(void, addNormalizePath__pureZpathnorm_u86)(NimStringV2 x_p0, NimStringV2* result_p1, NI* state_p2, NIM_CHAR dirSep_p3) {
	tyObject_PathIter__podQ0J5k3gvdWjKZmv8yZg it_1;
NIM_BOOL* nimErr_;
{nimErr_ = nimErrorFlag();
	nimZeroMem((void*)(&it_1), sizeof(tyObject_PathIter__podQ0J5k3gvdWjKZmv8yZg));
...
LA45_: ;
					colontmpD_ = substr__system_u9036(x_p0, b_1.Field0, b_1.Field1);
...
LA58_: ;
				colontmpD__2 = substr__system_u9036(x_p0, b_1.Field0, b_1.Field1);
...
LA63_: ;
		if (!T62_) goto LA64_;
		eqsink___system_u2749((&(*result_p1)), TM__DfU0iuayCGwHDN1Exp9cbKg_3);
	}
LA64_: ;
	}BeforeRet_: ;
}
